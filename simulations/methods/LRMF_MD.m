function [M_est, X, Y] = LRMF_MD(M, rank, lambda, lr, maxIter, tol)
%% Low-rank matrix factorization based matrix denoising (LRMF_MD) via gradient descent: 
